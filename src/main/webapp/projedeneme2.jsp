<%-- 
    Document   : projedeneme2
    Created on : 13 Ara 2023, 19:13:10
    Author     : Aidon
--%>
        ...
        <form method="POST" action="musteri_loginveri.jsp">
            ...
            <div>            
                ...
                <div class="login">
                    ...
                    <input type="text" id="email" name="isim" placeholder="Kullanıcı adınızı giriniz." required>
                        <br>
                        <input type="password" id="sifre" name="sifre"  placeholder="Şifrenizi giriniz." required>
                            ...
                            <input type="email" id="email" name="email" placeholder="E-posta adresinizi giriniz." required>
                                <button type="submit"  value="Login">Giriş yap</button>
