...
<html>
    ...
    <link href='https://fonts.googleapis.com/css?family=Open+Sans:300,400' rel='stylesheet' type='text/css'>
        <link href="//netdna.bootstrapcdn.com/font-awesome/4.0.3/css/font-awesome.css" rel="stylesheet">
            ...
            <body>
                <%if (request.getParameter("isim") != null || request.getParameter("email") != null || request.getParameter("email") != null) {
                        ...
                        session.setAttribute("isimg", isimgiris);
                        session.setAttribute("emailg", emailgiris);
                        session.setAttribute("sifreg", sifregiris);

                        adminkayit is = new adminkayit();
                        is.loginkontrol(isimgiris, emailgiris, sifregiris);

                        if (!is.isLogintest()) {
                            Cookie cookie = new Cookie("isimc", isimgiris);
                            cookie.setMaxAge(60 * 60 * 24);
                            response.addCookie(cookie);

                            Cookie cookie2 = new Cookie("emailc", emailgiris);
            ...
            <div id="container" id="timer">
                ...
                <h1>Admin Giriş Başarılı!</h1>
                <p>Giriş başarıyla yapıldı</p>

                <button onclick="window.location.href = 'adminpanel.jsp'">Rezervasyon Kontrol</button>
            ...
            <div id="main">
                <div class="fof">
                    <h1>Başarısız...</h1>
                    <br>
                    <a href='adminlogin.jsp'>Eksik veya yanlış bilgi girdiniz, lütfen tekrar giriş yapınız</a>
                </div>
            </div>
            <%
                    }
