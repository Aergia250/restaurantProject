    ...
    <link href='https://fonts.googleapis.com/css?family=Open+Sans:300,400' rel='stylesheet' type='text/css'>
        <link href="//netdna.bootstrapcdn.com/font-awesome/4.0.3/css/font-awesome.css" rel="stylesheet">
            ...
            <body>
                <%-- register.jsp --%>
                <%
                    if (request.getParameter("isimkayit") != null && request.getParameter("emailkayit") != null && request.getParameter("sifrekayit") != null) {
            ...
            <div id="main">
                <div class="fof">
                    <h1>Error 404</h1>
                    <br>
                    <a href='musteriregister.jsp'>Bu mail zaten kullanılıyor. Kayıt olmak için lütfen geri dönün.</a>
                </div>
            </div>
            <%
            } else {
            ...
            %>
                ...
                <div id="container" id="timer">
                    ...
                    <button onclick="window.location.href = 'musterilogin.jsp'">Giriş Yap</button>
            ...
            <%
                    ...
                    response.sendRedirect("musteriregister.jsp");
                }
            %>
            </body>
            </html>
