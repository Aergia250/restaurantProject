                ...
                <div class="food-items"> 
                    <img src="resim/iskender.jpg"> 
                        <div class="details"> 
                            ...
                            <input type="number" id="iskender" name="iskender" value="0" min="0" max="10">
                        </div>
                </div>
                ...
                <div class="food-items"> 
                    <img src="resim/doner.jpg"> 
                        <div class="details"> 
                            ...
                            <p>Baharatlı tavuk, ince dilimler halinde, nefis ekmek arasında unutulmaz bir lezzet.</p>
                            <input type="number" id="doner" name="doner" value="0" min="0" max="10">
                        </div>
                </div>
                ...
                <div class="food-items"> 
                    <img src="resim/adanakebap.jpg"> 
                        <div class="details"> 
                            ...
                            <input type="number" id="adana" name="adana" value="0" min="0" max="10">
                        </div>
                </div>
                ...
                <div class="food-items"> 
                    <img src="resim/tavuksis.jpg"> 
                        <div class="details"> 
                            ...
                            <input type="number" id="tavuk_sis" name="tavuksis" value="0" min="0" max="10">
                        </div>
                </div>
                ...
                <div class="food-items"> 
                    <img src="resim/beyti.jpg"> 
                        <div class="details"> 
                            ...
                            <input type="number" id="beyti" name="beyti" value="0" min="0" max="10">
                        </div>
                </div>
                ...
                <div class="food-items"> 
                    <img src="resim/kola3.jpg"> 
                        <div class="details"> 
                            ...
                            <input type="number" id="kola" name="kola" value="0" min="0" max="10">
                        </div>
                </div>
                ...
                <div class="food-items"> 
                    <img src="resim/fanta.jpg"> 
                        <div class="details"> 
                            ...
                            <input type="number" id="fanta" name="fanta" value="0" min="0" max="10">
                        </div>
                </div>
                ...
                <div class="food-items"> 
                    <img src="resim/ayran2.jpg"> 
                        <div class="details"> 
                            ...
                            <input type="number" id="ayran" name="ayran" value="0" min="0" max="10">
                        </div>
                </div>
            </div>
